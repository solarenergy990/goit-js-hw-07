...
//     firstArray.forEach(number => secondArray.includes(number) ? commonElements.push(number) : 0)
...
// const totalPlayTime = playtimes.reduce((prev, i) => {
//     return prev + i
// },0);
...
//    return users.reduce((allFriends, user) => [...allFriends, ...user.friends], []).length;
